...
To visualize the `dependent_tasks` pipeline of the [Handling multiple tasks](01_multiple_tasks.md) section, copy the following snippet into a Jupyter notebook cell:
